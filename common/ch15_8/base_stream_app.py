...
class BaseStreamApp():
    ...
    def offset_commit(self, epoch_id):
        offset_info = self.get_popen_rslt(
            f'/engine/hadoop-3.3.6/bin/hdfs dfs -cat /home/spark/kafka_offsets/{self.app_name}/offsets/{epoch_id}')
